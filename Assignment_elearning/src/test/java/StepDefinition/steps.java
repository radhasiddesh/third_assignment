...
public void i_enter_the_first_name_as(String string) throws InterruptedException {
     ...
     Thread.sleep(3000);
	driver.findElement(By.id("registration_firstname")).sendKeys("Radha");
}
...
public void i_enter_the_email_as(String string) {
	driver.findElement(By.id("registration_email")).sendKeys("radhasiddesh@gmail.com");
}
...
Thread.sleep(3000);
driver.findElement(By.xpath("//input[@type='search']")).sendKeys("radhasiddesh@gmail.com");
Thread.sleep(3000);
